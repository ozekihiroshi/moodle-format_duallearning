...
/**
 * Self-paced presentation decisions.
 */
final class path implements mode {
    /**
     * Return the self-paced heading key.
     *
    ...
    /**
     * Self-paced mode has no additional mode-specific shortcuts.
     *
