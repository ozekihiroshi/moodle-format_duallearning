...
Install the release ZIP using Moodle's plugin installer. It contains one top-level duallearning directory. Version 2026091800 upgrades alpha1 through the normal plugin upgrade process. No new tables, custom backup fields, external services, or build steps are introduced.
